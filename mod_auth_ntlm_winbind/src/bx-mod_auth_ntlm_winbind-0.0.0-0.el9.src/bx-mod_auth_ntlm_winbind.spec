...
#
%define mod_auth_ntlm_winbind_name mod_auth_ntlm_winbind
%define mod_auth_ntlm_winbind_version 0.0.0
#
%define svn 20070129svn713
#
Name: bx-%{mod_auth_ntlm_winbind_name}
Version: %{mod_auth_ntlm_winbind_version}
Release: 0%{?dist}
...
# sources, urls
Source0: bx-%{mod_auth_ntlm_winbind_name}-%{version}-%{svn}.tar.gz
Source1: bx-auth_ntlm_winbind.conf
Patch0: bx-%{mod_auth_ntlm_winbind_name}-20060510-connect_http10.patch
Patch1: bx-%{mod_auth_ntlm_winbind_name}-20070129-64bit.patch

# conflicts with old package
Conflicts: %{mod_auth_ntlm_winbind_name}
...
%prep
%setup -q -n bx-%{mod_auth_ntlm_winbind_name}
%patch -P0 -p1
%patch -P1 -p1
autoconf
...
%changelog
* Wed Jul 24 2024 Miroslav Sucha <msuchy@redhat.com> - 0.0.0-0.39.20070129svn713
